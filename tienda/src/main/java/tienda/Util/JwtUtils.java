...
public class JwtUtils {
    ...
    // Identificador del emisor del token, utilizado para identificar quién generó
    // el JWT.
    private static final String ISSUER = "server";

    // Constructor privado para evitar la instanciación de esta clase, ya que solo
    ...
    /**
     * Intenta analizar un token JWT y devolver sus Claims (información contenida en
     * el token).
     * 
     * @param jwtToken El token JWT a analizar.
     * @return Un Optional con los Claims si el análisis tiene éxito;
     *         Optional.empty() en caso de error.
     */
     ...
     * @return Un Optional con el nombre de usuario si el token es válido;
     ...
     * 
     * @param username El nombre de usuario que se establecerá como subject en el
     *                 token.
    ...
    public static String generateToken(String username) {
        ...
        // Calcula la fecha de expiración sumando los minutos definidos a la fecha
        // actual.
